...
const Features =() => {
    ...
    return(
        <section className="flex flex-col mt-0 lg:mt-[12rem]">
            ...
            <div className="flex flex-col gap-6 justify-center items-center lg:items-start max-w-[463px]">
            <MainTitle title="Say goodbye to long, tiresome documents" className=" mb-3 font-semibold lg:text-4xl text-3xl"/>
           ...
           <div className="mx-auto lg:mx-0 mt-10 hidden lg:block">
            <img src={FeatureImage} alt="Image of our features we offer at afforia" className="max-w-[599px] h-[549px]"/>
           </div>
