  ...
  return (
    <section className="flex flex-col mt-0 md:mt-[8rem] lg:mt-[12rem]">
      <div className="flex md:justify-evenly flex-wrap ">
        <div className="flex flex-col gap-6 justify-center items-center md:items-start max-w-[549px]">
          <MainTitle
          ...
          <Paragraph
            ...
            className=" font-normal tracking-[0.02rem] leading-6 px-4 lg:px-0"
          />
        ...
        <div className="mx-auto md:mx-0 mt-10 hidden lg:block">
          <img
            src={FeatureImage}
        ...
        <div className="mx-auto md:mx-0 mt-10 lg:hidden block">
          <img
