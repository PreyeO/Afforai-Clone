...
const Hero = () => {
  return (
    <section className="flex flex-col mt-[32px] py-4 max-w-screen-xl mx-auto">
          
      <div className="text-center flex flex-col gap-[32px] justify-center items-center overflow-hidden ">
        
        <div
          className="container flex items-center space-x-2 p-2 pl-4 rounded-lg border-2 border-gray-700  text-gray-700 text-sm font-semibold w-auto h-[44px]"
        >
          <img src={ApsumoLogo} alt="ApsumoLogo" className="w-[26px] h-[20px]"/>
          <SubTitle title="Now on AppSumo" className="text-[13px] text-[#525252] leading-10"/>
          <div className="flex text-[13px] items-center justify-center gap-2 rounded-lg
        ...
        <MainTitle title="Your second brain for maximizing productivity" className="lg:text-5xl 
        ...
        <div className="flex gap-7 flex-wrap justify-center ">
          <TryBtn label="Try for free"  className="w-[340px]"/>
          <LightBtn label="View pricing"  className="w-[340px]"/>
        </div>

        <div className=" z-20 mx-auto lg:flex lg:flex-col justify-center 
        ...
        <div className="hidden z-10  absolute bottom-[-210px] w-[100%]  mx-auto lg:flex flex-col justify-center items-center">
          <img
            src={rgbBg}
            alt="image to show how it works"
