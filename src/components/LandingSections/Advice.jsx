...
const Advice =() => {
    ...
    return(
      ...
      <Paragraph title="Join an ever-growing community, and get with Afforai started free of charge!" className="font-normal tracking-[0.02rem] leading-6"/>
      <TryBtn label="Get Started for Free" className="inline-block max-w-[700px]"/>
      </div>
            <div className=" z-20 mt-[-200px]">
            <img src={RGB} alt="Image of our features" className="rounded-2xl lg:w-[1408px] h-[289px]"/>
           </div>
