...
const NavBar = () => {
  ...
  return (
    <nav
      className={` p-3 text-[#111111] font-medium max-w-[1264px] mx-auto h-auto px-8 border border-solid border-gray-300 rounded-xl backdrop-filter backdrop-blur-md bg-opacity-50 fixed top-0 left-0 right-0 z-50 lg:my-5 bg-white ${
    ...
    >
      <div className="relative flex justify-between items-center flex-wrap">
        ...
        <div
          className={
            isMenuOpen
              ? "block order-1 flex-shrink-0 lg:order-[-1] w-[94px] text-left"
              : "lg:flex"
          }
        >
          <ul className="lg:flex gap-8 text-sm mt-2 lg:mt-0 ">
