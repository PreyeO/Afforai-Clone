...
export const reviews = [
    ...
    },
    {
      ...
      },
      {
        ...
        author: "Jane Smith",
        content:
          "Great tool for text analysis and emphasizing the main idea of a document. Especially when you need a quick answer without tones of epithets that beautifully describe something that can be actually described in a few words:).",     image: photo4,
      },
      {
        id: 5,
        author: "Jane Smith",
  ...
  export const comments = [
    ...
    },
    {
      ...
      },
      {
        ...
        author: "Jane Smith",
        content:
          "Great tool for text analysis and emphasizing the main idea of a document. Especially when you need a quick answer without tones of epithets that beautifully describe something that can be actually described in a few words:).",     image: photo11,
      },
      {
        id: 5,
        author: "Jane Smith",
